...
const callToActionData = {
    title: "Need IT Consultant?",
    subtitle: "We provide company and finance service for\n" +
                    ...
                    <div className="col-lg-4 col-md-4">
                        ...
                        animateOnce={true}>
                            <div className="call-to-btn text-start mt_sm--20 text-md-end">
                                <a className="btn-default btn-icon" target="" href="#about">{callToActionData.btnText} <i className="icon"><FiArrowRight /></i></a>
                            </div>
                        </ScrollAnimation>
                    </div>
                </div>
